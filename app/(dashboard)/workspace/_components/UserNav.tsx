    ...
    <DropdownMenu>
        <DropdownMenuTrigger asChild>
            <Button variant={'outline'} size={"icon"} 
                className='size-12 rounded-xl hover:rounded-lg transition-all duration-200 bg-background/50 border-border/50 
        ...
        <DropdownMenuContent align='end' side='right' sideOffset={8} className='w-[200px]'>
            <DropdownMenuLabel className='font-normal flex items-center gap-2 px-1'>
                ...
                <div className='grid flex-1 text-left text-sm leading-tight'>
                    ...
                    <p className='text-muted-foreground truncate text-xs'>Johnwick@gmail.com</p>
                </div>
            </DropdownMenuLabel>
            <DropdownMenuSeparator/>
            <DropdownMenuGroup>
                <DropdownMenuItem asChild>
                    <PortalLink className="flex items-center gap-2 w-full">
                        <User />
                        <span>Account</span>
                    </PortalLink>
                </DropdownMenuItem>
